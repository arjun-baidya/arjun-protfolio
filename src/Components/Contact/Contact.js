            ...
            <Container>
                <Row className="mycontact-row">
                    ...
                    <Col sm={12} md={7} className="my-contact-col">
                        <h1>Contact Me</h1>
                        <p>
                            I am available on almost every social media. You can message me, I will reply within one hours. I can help you with Web-Development,Django-Rest-Framework, React, Node JS, Odoo ERP and Opensource Development.
                        </p>
